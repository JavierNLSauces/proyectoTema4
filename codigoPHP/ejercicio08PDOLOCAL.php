...
<html>
    ...
    <body>
        ...
        try { // Bloque de código que puede tener excepciones en el objeto PDO
            ...
            if ($documentoXML->save("../tmp/" . $fechaActual . "exportacionXMLLocal.xml")) { // guarda el arbol XML en la ruta especificada con la fecha del dia que se ejecuta
                ?>
        <p><a href="exportacionLocalXML.php" style="text-decoration:none; color:black; border:1px solid black;">Descargar XML</a></p>
                <?php
                highlight_file("../tmp/" . $fechaActual . "exportacionXMLLocal.xml");
            }
